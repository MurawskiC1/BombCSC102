...
# constants
COUNTDOWN = 300         # the bomb's initial countdown timer value (seconds)
BUTTON_LED = "R"        # the pushbutton's LED color (R, G, or B)
MAX_PASS_LEN = 8        # the maximum passphrase length
STAR_CLEARS_PASS = True # does the asterisk (*) clear the passphrase?
